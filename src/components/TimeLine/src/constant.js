...
export const ZOOM = [
  0.5, 1, 2, 6, 12, 24,
  //  72, 360, 720, 8760, 87600
]; // 半小时、1小时、2小时、6小时、12小时、1天、3天、15天、30天、365天、365*10天
...
// export const ONE_HOUR_STAMP = 60 * 60 * 1000;
// export const ZOOM = [0.5, 1, 2, 6, 12, 24];
// export const ZOOM_HOUR_GRID = [1 / 60, 1 / 60, 2 / 60, 1 / 6, 0.25, 0.5];
